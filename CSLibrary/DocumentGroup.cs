...
namespace CudaSign
{
	public class DocumentGroup
	{
		...
		internal DocumentGroup(CudaSignClient client)
		{
			this.client = client;
		}
		...
		public DocumentGroupInfo Get(OAuth2Token accessToken, string GroupId = "", string ResultFormat = "JSON")
		{
			...
			return response.GetResult<DocumentGroupInfo>();
		}
